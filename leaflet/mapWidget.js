...
mapWidget.prototype.createMap = function(parent,nextSibling) {
	...
	map = L.map('lfltMap').setView([setting.lat,setting.lg],setting.zoom);
...
//console.log(plcs.tiddler);
			var coord = this.wiki.getTiddler(plcs.tiddler).fields.coord;
console.log(coord);
			if(coord) {
				var location=eval("["+coord+"]");
				var html="<h4>"+this.wiki.getTiddler(plcs.tiddler).fields.title+"</h4>"+this.wiki.getTiddler(plcs.tiddler).fields.text;
				L.marker(location, {icon: lfltIcon}).bindPopup(html).addTo(map);
			}
		}
	}
...
data:image/png;base64,
*/